    ...
    <header>
      <Container>
        <div className="flex justify-between items-center flex-wrap">
          ...
          <div className="flex max-lg:order-last max-lg:w-[100%] max-lg:mb-3" onKeyUp={submitHandler}>
            <input
            value={query}
            ...
            />
            <button onClick={submitHandler} className=" tracking-wide w-[100%] max-w-[80px] bg-red-600 py-1 font-semibold  text-[#fff] rounded-tr-lg rounded-br-lg">
              Search
            </button>
          </div>
